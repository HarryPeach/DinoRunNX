...
(function () {
    ...
    GameOverPanel.prototype = {
        ...
        draw: function () {
            ...
            // Game over text.
            var textSourceX = dimensions.TEXT_X * 2;
            var textSourceY = dimensions.TEXT_Y * 2;
            var textSourceWidth = dimensions.TEXT_WIDTH * 2;
            var textSourceHeight = dimensions.TEXT_HEIGHT * 2;
            ...
            var restartSourceWidth = dimensions.RESTART_WIDTH * 2;
            var restartSourceHeight = dimensions.RESTART_HEIGHT * 2;
    ...
    Obstacle.types = [
        ...
        },
        {
            ...
            width: 92,
            height: 80,
            yPos: [200, 150, 100], // Variable height.
            ...
            collisionBoxes: [
                ...
                new CollisionBox(4, 28, 8, 6), // unchngd
                new CollisionBox(12, 20, 8, 14), // unchngd
                new CollisionBox(20, 16, 12, 18) // unchngd
            ],
            numFrames: 2,
            frameRate: 1000 / 6,
            speedOffset: .8
    ...
    Trex.prototype = {
        ...
        draw: function (x, y) {
            ...
            var sourceHeight = this.config.HEIGHT * 2;
    ...
    DistanceMeter.prototype = {
        ...
        draw: function (digitPos, value, opt_highScore) {
            var sourceWidth = DistanceMeter.dimensions.WIDTH * 2;
            var sourceHeight = DistanceMeter.dimensions.HEIGHT * 2;
            var sourceX = DistanceMeter.dimensions.WIDTH * value * 2;
            var sourceY = 0;
    ...
    Cloud.prototype = {
        ...
        draw: function () {
            this.canvasCtx.save();
            var sourceWidth = Cloud.config.WIDTH * 2;
            var sourceHeight = Cloud.config.HEIGHT * 2;
    ...
    // NightMode.phases = [240, 120, 100, 60, 40, 20, 0];
    ...
    NightMode.prototype = {
        ...
        draw: function () {
            ...
            var moonSourceX = this.spritePos.x + (NightMode.phases[this.currentPhase] * 2);
